...
# Inserire i valori dentro la funzione ammortamentoItaliano riga 60
def ammortamentoItaliano(n,v,k,i,s) :
    ...
    plt.show()
ammortamentoItaliano(10,1,4,0.075,110000)